...
<div id="control-panel">
  ...
  function updateUI() {
    ...
    targets.forEach((entry) => {
      ...
      const requiredShortWinRateContainer = row.find(".required-short-win-rate");
...
function isMeTabActive() {
  ...
  return Array.from(meTab.classList).some(cls => cls.startsWith('_activeTab'));
}
