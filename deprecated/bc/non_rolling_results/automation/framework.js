...
;(function () {
    ...
    function initRollHandler() {
        ...
        class Target {
            ...
            getStreak() {
                ...
                for (let i = this.results.length - 1; i >= 0; i--) {
                  const hit = this.results[i] >= this.value;
        ...
        class RollHandler {
            constructor(targets, bankRoll, results) {
            ...
            getNextRiskTarget() {
                throw "Must implement getNextRiskTarget";
            }
        }
        ...
        return new RollHandler(targets, new BankRoll(100), RESULTS)
    }
...
class MockBC {
  ...
  generateSeed() {
    // Generate a new GUID or random string for each session
