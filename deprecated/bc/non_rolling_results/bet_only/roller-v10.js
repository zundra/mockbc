...
;(function () {
    ...
    function startBetting() {
        ...
        if (getRiskOn() && getUseDynamicWagering()) {
    ...
    function initTarget() {
        ...
        class RiskOnTarget {
            ...
            setWager() {
                ...
                this.wager = Math.max(this.baseWager, Math.min(MAX_WAGER, this.wager * (1.5 * lsRatio)));
            }
            getStreak() {
                return this.streak;
            }
        ...
        return new RiskOnTarget(getPayout(), getWager(), getBaseWager(), getBalance());
    }
