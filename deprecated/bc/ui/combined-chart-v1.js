...
(function () {
 ...
 function createEvent(ratioVal, result, pending, currentRoll, isPending) {
  ...
  function renderWinRateChart() {
    ...
    const dsLeash = winrateChart.data.datasets.find(
      (ds) => ds.label === "Leash"
    );
...
`
    ...
    const uiHTML = `<div id="draggable-charts-container"><table><tr><td><div id="charts-container" class="container">
...
</div></td><td style="vertical-align: top;">    <div id="pop-log">
