    ...
    class Target {
      ...
      addRiskOnResult(result) {
        ...
        if (result >= this.getPayout()) {
          ...
          if (this.getPL() >= (this.payout * this.baseWager * 2)) {
            console.log(`Going risk off on early win ${this.profit}`)
            this.goRiskOff();
          } else if (this.attemptCount > 1 && this.getPL() > 0) {
            this.goRiskOff();
          } else if (this.isRiskOffReady()) {
            if (this.getPL() < 0) {
              this.attemptCount++;
              this.wager = this.wager * this.attemptCount;
              this.riskOnRollCount = 0;
            } else {
              this.goRiskOff();              
            }
          ...
          // if (this.riskOnLosingStreak >= this.payout - 1) {
          //   console.log(
          //     `[Failed Attempt (${rollCount})] 
          //     Wager=${this.wager}, 
          //     Profit=${this.profit}, 
          ...
          if (this.attemptCount > 1 && this.getPL() > 0) {
            this.goRiskOff();
          } else if (this.isRiskOffReady()) {
            if (this.getPL() < 0) {
              this.attemptCount++;
      ...
      isRiskOffReady() {
        return (
          this.riskOnRollCount === 100
          //this.getWinRatePercentOfTeo(10) > 100 &&
          // this.getWinRatePercentOfTeo(20) > 100 &&
          // this.getWinRatePercentOfTeo(30) > 100 &&
          // this.getWinRatePercentOfTeo(40) > 100 &&
          //this.getWinRatePercentOfTeo(50) > 100 
          // this.getWinRatePercentOfTeo(60) > 100 &&
          // this.getWinRatePercentOfTeo(70) > 100 &&
          // this.getWinRatePercentOfTeo(80) > 100 &&
          // this.getWinRatePercentOfTeo(90) > 100 &&
