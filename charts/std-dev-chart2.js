// ==UserScript==
// @name         Volatility Regime Detector + Compression Stats
...
(function () {
  ...
  function renderChart() {
    ...
    regimeChart.data.datasets[1].data.push(1);
    regimeChart.data.datasets[2].data.push(0.5);
